...
/* package upenn-0.1.0.0 */
#ifndef VERSION_upenn
#define VERSION_upenn "0.1.0.0"
#endif /* VERSION_upenn */
#ifndef MIN_VERSION_upenn
#define MIN_VERSION_upenn(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_upenn */
...
#define CURRENT_COMPONENT_ID "upenn-0.1.0.0-inplace-upenn"
